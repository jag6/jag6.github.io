...
export const vocab = [
    ...
    ['turn, rotate', '回す', 'まわす', 'まわ'],
    ['float', '浮く', 'うく', 'う'],
    ['hesitate', '躊躇う', 'ためらう', 'ためら'],
    ['slip', '滑る', 'すべる', 'すべ'],
    ['catch, grasp, grip', '掴む', 'つかむ', 'つか'],
    ['poor', '貧しい', 'まずしい', 'まず'],
